...
const markers = [
    ...
    {coef: 0.75, markerOffsetX: 0, markerOffsetY: 25, name: "Turkmenistan", count: '0.05 mln', coordinates: [58.34271047192892, 37.95425350060607]},
    {coef: 1, markerOffsetX: 0, markerOffsetY: -25, name: "Ukraine", count: '0.045 mln', coordinates: [30.518859183525734, 50.47454792867506]},
    {coef: 0.75, markerOffsetX: 0, markerOffsetY: -18, name: "Uzbekistan", count: '0.044 mln', coordinates: [69.27092465935283, 41.30030651564409]},
    ...
    {markerOffsetX: 0, markerOffsetY: 25, name: "UAE", count: '7000', coordinates: [54.36593134228087, 24.46364730906931]},
    {markerOffsetX: 0, markerOffsetY: -25, name: "Netherlands", count: '7000', coordinates: [4.908561580391376, 52.377015534378295]},
    {markerOffsetX: 0, markerOffsetY: -25, name: "Canada", count: '6425', coordinates: [-75.7282808008842, 45.43629793649681]},
    {markerOffsetX: 0, markerOffsetY: -25, name: "Belarus", count: '6001', coordinates: [27.547316304444138, 53.903651885990875]},
    {markerOffsetX: 0, markerOffsetY: -25, name: "Sweden", count: '3865', coordinates: [18.062910575081016, 59.33567095951924]},
...
function CommunityMap() {
    return (
        <div className={style.mapWrapper}>
            <h2>Our community</h2>
            <p>Is Azerbaijani communities from all over the world!</p>
            <ComposableMap
                className={style.map}
            >
